    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        floatingActionButtonTheme: ThemeData.light()
            ...
            .copyWith(backgroundColor: Colors.lightGreen  ),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void addNewTransaction({String tx, double txAmount,DateTime choosenDate}) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Expense Manager',style:TextStyle(fontFamily:'OpenSans',fontWeight: FontWeight.w600)
        ),
        actions: <Widget>[
          IconButton(
            icon: Icon(Icons.add),
